(function() {
var __customevents = {}, __protocol = {}, __connector = {}, __timer = {}, __options = {}, __reloader = {}, __livereload = {};
var urlQueryExpr = /(.*?\.(\w+))(\?.*)?$/;
// customevents
var CustomEvents;
CustomEvents = {
...
Options.extract = function(document) {
  ...
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    if ((src = element.src) && (m = src.match(/^[^:]+:\/\/(.*)\/z?livereload\.js(?:\?(.*))?$/))) {
      ...
      if (mm = m[1].match(/^([^\/:]+)(?::(\d+))?/)) {
        options.host = mm[1];
        options.port = (parseInt(mm[2], 10) || 80) + 100;
      }
      if (m[2]) {
        _ref2 = m[2].split('&');
...
(function() {
  ...
  numberOfMatchingSegments = function(path1, path2) {
    var comps1, comps2, eqCount, len, args1, args2;

    args1 = urlQueryExpr.exec(path1) || [];
    args2 = urlQueryExpr.exec(path2) || [];

    path1 = (args1[1] || path1).toLowerCase();
    path2 = (args2[1] || path2).replace(/\\/g,'/').replace(/^\/+/, '').toLowerCase();
    if (path1 === path2) {
      return 10000;
    }
  ...
  __reloader.Reloader = Reloader = (function() {
    ...
    Reloader.prototype.reload = function(path, options) {
      ...
      if(this.needReload(path)) {
        return this.reloadPage();
      }
    };

    Reloader.prototype.needReload = function (path) {
      var args = urlQueryExpr.exec(path) || [];
      switch (args[2]) {
        case 'js':
          var ref = this.document.getElementsByTagName('script');
          for (var i = 0, s; (s = ref[i]); i++) {
            if (s.src && pathsMatch(s.src, path)) {
              return true;
            }
          }
          break;
    ...
    Reloader.prototype.reloadStylesheet = function(path) {
      var imported, link, links, match, style, _i, _j, _k, _len, _len1, _len2, _ref, _ref1,
        _this = this;
      links = (function() {
      ...
      if (match) {
        if (match.object.rule) {
          ...
          this.reattachStylesheetLink(match.object, path);
        }
      } /* else {
    ...
    Reloader.prototype.reattachStylesheetLink = function(link) {
      ...
      clone.href = this.generateCacheBustUrl(clone.href);
